...
function makePlaceholder(filename: string, brand: string, name: string, bg: string, fg: string) {
  ...
  <text x="60" y="880" font-family="Arial Black, Arial, sans-serif" font-size="40" font-weight="900" fill="${fg}" opacity="0.35">stroke — salò</text>
  <rect x="0" y="976" width="200" height="24" fill="#e8432d"/>
  <rect x="200" y="976" width="200" height="24" fill="#f58220"/>
  <rect x="400" y="976" width="200" height="24" fill="#ffd21e"/>
  <rect x="600" y="976" width="200" height="24" fill="#f2f0ea"/>
</svg>`;
...
const PRODUCTS: SeedProduct[] = [
  ...
  { brand: "Obey", category: CATEGORIES.tee, name: "Bold Logo Tee Pigment Black", price: 45, purchase: 21, season: Season.SUMMER, year: 2026, descIt: "Logo Obey bold su tintura pigment, vestibilità boxy.", descEn: "Bold Obey logo on pigment dye, boxy fit.", sizes: { S: 0, M: 1, L: 1 }, colors: ["#252527", "#ffd21e"] },
  ...
  { brand: "HUF", category: CATEGORIES.tee, name: "Plantlife Tee", price: 42, purchase: 20, season: Season.SUMMER, year: 2026, descIt: "La grafica Plantlife più famosa di HUF.", descEn: "HUF's most famous Plantlife graphic.", sizes: { S: 1, M: 1, L: 1 }, colors: ["#1f3d2b", "#ffd21e"] },
  ...
  { brand: "Iuter", category: CATEGORIES.hoodie, name: "Logo Hoodie Bordeaux", price: 89, purchase: 44, season: Season.WINTER, year: 2025, descIt: "Il logo Iuter ricamato, made in Milano dal 2002.", descEn: "Embroidered Iuter logo, made in Milan since 2002.", sizes: { S: 1, M: 0, L: 1 }, colors: ["#5a1f2b", "#f2f0ea"] },
